...
export default function NeighborhoodSection() {
  return (
    <section id='neighborhoods' className='py-12 md:py-16 bg-white'>
            ...
            <Link
              ...
              <Card className='overflow-hidden h-full'>
                <div className='relative aspect-[4/3] overflow-hidden'>
                  <Image src={neighborhood.image || '/placeholder.svg'} alt={neighborhood.name} className='object-cover' fill />
                </div>
